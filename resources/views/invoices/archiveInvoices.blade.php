									...
									<table id="example" class="table key-buttons text-md-nowrap">
										...
										<tbody>
                                          ...
                                          <tr>
                                            ...
                                            <th>
                                                {{-- <a  class="dropdown-item btn" data-toggle="modal" data-target="#exampleModal" data-whatever="{{$invoice->id}}">unarchive</a> --}}
                                                <a  class="dropdown-item btn" data-toggle="modal" data-target="#exampleModal" data-whatever="{{$invoice->id}}">processes</a>
      ...
      <div class="modal-content">
        ...
        <div class="modal-body row">
            <div class="col-6">
                ...
                <form action="{{route('unArchiveInvoices.unArchive')}}">
