...
@section('page-header')
    ...
    <div class="breadcrumb-header justify-content-between">
        ...
        <div class="main-dashboard-header-right">
            ...
            <div>
                <label class="tx-13">commesions</label>
                <h5>{{ App\Models\invoices::sum("Total") }}</h5>
            </div>
            <div>
                <label class="tx-13">Offline Sales</label>
                <h5>{{ App\Models\invoices::withTrashed()->sum("Amount_collection") }}</h5>
            </div>
        </div>
    </div>
    <!-- /breadcrumb -->
    ...
    <div class="row row-sm">
                        ...
                        <div class="d-flex">
                            <div class="">
                                <h4 class="tx-20 font-weight-bold mb-1 text-white">
                                    ...
                                    {{ number_format(\App\Models\invoices::withTrashed()->sum('Amount_collection'), 2) }}
                                </h4>
                        ...
                        <div class="d-flex">
                            <div class="">
                                <h3 class="tx-20 font-weight-bold mb-1 text-white">
                                    ...
                                    {{ number_format(\App\Models\invoices::where('Value_Status', 0)->sum('Amount_collection'), 2) }}

                                </h3>
                                <p class="mb-0 tx-12 text-white op-7">{{ \App\Models\invoices::where('Value_Status', 0)->count() }}
                                </p>
                            </div>
                            <span class="float-right my-auto mr-auto">
                                ...
                                <span class="text-white op-7">
                                    ...
                                    $count_invoices2 = \App\Models\invoices::where('Value_Status', 0)->count();
        ...
        <div class="col-xl-3 col-lg-6 col-md-6 col-xm-12">
            <div class="card overflow-hidden sales-card bg-warning-gradient">
                <div class="pl-3 pt-3 pr-3 pb-2 pt-0">
                    <div class="">
                        <h6 class="mb-3 tx-12 text-white">الفواتير  المؤرشفه</h6>
                    </div>
                    <div class="pb-0 mt-0">
                        <div class="d-flex">
                            <div class="">
                                <h4 class="tx-20 font-weight-bold mb-1 text-white">
                                    ...
                                    {{ number_format(\App\Models\invoices::onlyTrashed()->sum('Total'), 2) }}

                                </h4>
                                <p class="mb-0 tx-12 text-white op-7">
                                    {{ \App\Models\invoices::onlyTrashed()->count() }}
                                </p>
                            </div>
                            <span class="float-right my-auto mr-auto">
                                <i class="fas fa-arrow-circle-down text-white"></i>
