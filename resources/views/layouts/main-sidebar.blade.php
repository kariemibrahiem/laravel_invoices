			...
			<div class="main-sidemenu">
				...
				<ul class="side-menu">
					...
					<li class="slide">
						...
						<ul class="slide-menu">
							<li><a class="slide-item" href="{{ url('/' . $page='invoices') }}">فواتير مدفوعه</a></li>
							<li><a class="slide-item" href="{{ url('/' . $page='chart-flot') }}">فواتير غير مدفوعه</a></li>
							<li><a class="slide-item" href="{{ url('/' . $page='chart-chartjs') }}">فواتير مدفوعه جزءيا</a></li>
