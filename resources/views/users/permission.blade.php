...
@section('page-header')
				...
				<div class="breadcrumb-header justify-content-between">
					<div class="my-auto">
						<div class="d-flex"><h4 class="content-title mb-0 my-auto">المستخدم</h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">/ الاذن</span></div>
					</div>
								...
								<div class="main-mail-header">
									...
									<div>
                                        <div class="d-flex justify-content-between">
                                            <h4 class="card-title mg-b-0"><a class="modal-effect btn btn-outline-primary btn-block" data-effect="effect-scale" data-toggle="modal" href="#modaldemo1">انشاء الاذن </a></h4>
                                        </div>
										<h4 class="main-content-title mg-b-5">الاذن</h4>
                                        ...
                                        <table id="example" class="table key-buttons text-md-nowrap">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th class="wd-15p border-bottom-0">اسم الاذن </th>
                                            ...
                                            <tbody>
                                              ...
                                              <tr>
												...
												<th>
													<a  class="dropdown-item btn" data-toggle="modal" data-target="#exampleModal" data-whatever="{{$permission->id}}">delete</a>
												</th>
                                            </tr>
            ...
            <div class="modal-content modal-content-demo">
                ...
                <div class="modal-body">
                    <form action="{{route("permissions.store")}}" method="POST">
                            @csrf
                            <label calss=" text-success text-xl"  for=""> permission name</label>
                            <input type="text" class="form-control w-75  m-3" placeholder="the name of permission " id="permission"  name="permission">
      ...
      <div class="modal-content">
        ...
        <div class="modal-body row">
            <div class="col-6">
                ...
                <form action="{{route('permissions.delete')}}">
                    <div class="form-group">
